...
const TAROT_CARDS: Record<string, TarotCardDef> = {
  ...
  'The Star':            { abilityName: '希望灯塔', abilityDescription: '死亡后Soul NFT评级自动+1级', abilityValue: 0.5, weaknessName: '过于理想', weaknessDescription: '现实收益-5%', weaknessValue: 0.2, cooperationMod: 0.10, riskMod: -0.05, specialMechanic: 'beacon_hope' },
